    ...
    data: new SlashCommandBuilder()
        ...
        .addSubcommand((subcommand) =>
            ...
            .addStringOption((option) =>
                ...
                .setRequired(true)
                .addChoices({ name: "EN", value: "EN" }, { name: "CIS", value: "CIS" }, { name: "PT", value: "PT" }, { name: "ES", value: "ES" }, { name: "TH", value: "TH" }, { name: "OTHER", value: "OTHER" })
            )
        )
        .addSubcommand((subcommand) =>
            subcommand
    ...
    async execute(interaction) {
        ...
        if (subCommand === "team") {
            ...
            await feishu.updateRecord(
                ...
                CS_BASE,
                CS_TABLE,
                memberRecordId, { fields: { Title: "Leader", Region: teamRegion } }
            );
